...
import PermssionForm from "./Form/permissionForm";
...
export default function PermssionCard(props) {
  ...
  console.log(
    "gggg",
    Userinf.userinfo !== undefined ? Userinf.userinfo.photo.secure_url : "hello"
  );
      ...
      <div className=" h-[100%]  w-[100%] absolute flex justify-center items-center  flex-col top-0  ">
        ...
        >
          ...
          <input
            ...
            value={subject}
          />
          <p className="mt-1 text-sm peer-invalid:visible text-red-700 text-lightwg m-0">
            From
          </p>
          <input
            type="date"
      ...
      if (role == "lecturer" || role == "parent") {
        return (
          <div className="flex gap-4 flex-wrap">
            <p
              className=" w-[100px] text-[green] flex justify-center  items-center gap-1 cursor-pointer"
              onClick={() => {
                setIsView(!isView);
                updateData(
                  `/updateleave/${props.id}`,
                  roleBasedUpdate(1),
                  isAuthenticated().token
                );
              }}
            ...
            <p
              className=" w-[100px] text-[#EA8B9E] flex justify-center  items-center gap-1 cursor-pointer"
              onClick={() => {
                setIsView(!isView);
                updateData(
                  `/updateleave/${props.id}`,
        ...
        return (
          <div className="flex gap-9">
            <svg
              ...
              onClick={() => {
                setIsView(!isView);
                deleteData(`/deleteleave/${props.id}`, isAuthenticated().token);
              }}
            >
          ...
          {isAuthenticated().user.role == "lecturer" ? (
            <div className="flex gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[#606F7B] font-[Avenirregular] m-0">
                  {" "}
                  {props.htno !== undefined ? props.htno : "....."}
                </p>{" "}
              </div>{" "}
            </div>
          ) : (
