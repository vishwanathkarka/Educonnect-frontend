  ...
  return (
        ...
        }
   {
    attendances && attendances.map(attendance=>{ 
       return <Attendaceui htno={moment(attendance.timeStamp).format("MMM Do YY")} key ={attendance._id} isPresent={attendance.isPresent}  name = {attendance.lectureId.firstName}/>
    })
   }
   </>
  )
